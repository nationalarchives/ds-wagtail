    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('record', app.ciim.fields.RecordField(db_index=True, help_text='If the image relates to a specific record, select that record here.', max_length=50, null=True, verbose_name='related record')),
                ('record_dates', models.CharField(help_text='Date(s) related to the selected record (max length: 100 chars).', max_length=100, verbose_name='record date(s)')),
                ('description', wagtail.fields.RichTextField(help_text='This text will appear in highlights galleries. A 100-300 word description of the story of the record and why it is significant.', max_length=900, verbose_name='description')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teaser_text', models.TextField(help_text='A short, enticing description of this page. This will appear in promos and under thumbnails around the site.', max_length=160, verbose_name='teaser text')),
                ('intro', wagtail.fields.RichTextField(help_text='1-2 sentences introducing the subject of the page, and explaining why a user should read on.', max_length=300, verbose_name='introductory text')),
                ('body', wagtail.fields.StreamField([('large_card_links', 3)], blank=True, block_lookup={0: ('wagtail.blocks.CharBlock', (), {'max_length': 100, 'required': False}), 1: ('app.core.blocks.page_chooser.APIPageChooserBlock', (), {'label': 'Link one target', 'required_api_fields': ['teaser_image']}), 2: ('app.core.blocks.page_chooser.APIPageChooserBlock', (), {'label': 'Link two target', 'required_api_fields': ['teaser_image']}), 3: ('wagtail.blocks.StructBlock', [[('heading', 0), ('page_1', 1), ('page_2', 2)]], {})})),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intro', wagtail.fields.RichTextField(help_text='1-2 sentences introducing the subject of the page, and explaining why a user should read on.', max_length=300, verbose_name='introductory text')),
                ('body', wagtail.fields.StreamField([('large_card_links', 3)], blank=True, block_lookup={0: ('wagtail.blocks.CharBlock', (), {'max_length': 100, 'required': False}), 1: ('app.core.blocks.page_chooser.APIPageChooserBlock', (), {'label': 'Link one target', 'required_api_fields': ['teaser_image']}), 2: ('app.core.blocks.page_chooser.APIPageChooserBlock', (), {'label': 'Link two target', 'required_api_fields': ['teaser_image']}), 3: ('wagtail.blocks.StructBlock', [[('heading', 0), ('page_1', 1), ('page_2', 2)]], {})})),
                ('stories_title', models.CharField(blank=True, default='Stories from the collection', help_text='The title to display for the articles section.', max_length=100)),
                ('stories_introduction', models.CharField(blank=True, help_text='The introduction to display for the articles section.', max_length=200)),
                ('stories_hero_image_caption', wagtail.fields.RichTextField(blank=True, null=True)),
                ('explorer_index_page_selections_title', models.CharField(blank=True, help_text='The title to display for the Explorer Index Page selections.', max_length=100)),
