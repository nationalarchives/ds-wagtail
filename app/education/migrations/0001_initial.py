# Generated by Django 6.0.5 on 2026-05-15 12:29
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "selected_page",
                    models.ForeignKey(
                        help_text="Navigation to a related page",
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="+",
                        to="wagtailcore.page",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "session_price",
                    models.FloatField(
                        blank=True, null=True, verbose_name="session price"
                    ),
                ),
                (
                    "session_price_detail",
                    models.CharField(
                        blank=True,
                        help_text="An explanation of the price. Required if session price is filled in.",
                        max_length=160,
                        verbose_name="session price detail",
                    ),
                ),
                (
                    "session_booking_link",
                    models.URLField(
                        blank=True,
                        ...
                        block_lookup={
                            0: (
                                ...
                                (),
                                {
                                    ...
                                    "help_text": "Add the session description.",
                                    "label": "Heading",
                                    "required": True,
                                },
                            ),
                            ...
                            2: (
                                "app.core.blocks.image.PartnerLogoChooserBlock",
                                (),
                                {
                                    "help_text": "An image for the partner logo.",
                            ...
                            8: (
                                ...
                                [
                                    [
                                        ("citation_internal_link", 6),
                                        ("citation_external_link", 7),
                                    ]
                                ],
                                {},
                            ),
                            9: (
                                "wagtail.blocks.StructBlock",
                                [[("citation", 5), ("source_link", 8)]],
                                {},
                            ),
                            10: (
                                "wagtail.blocks.StructBlock",
                                [[("quote", 3), ("attribution", 4), ("source", 9)]],
                                {
                                    "help_text": "A quote with an attribution related to the session."
                                },
                            ),
                            11: (
                                "app.core.blocks.paragraph.APIRichTextBlock",
                            ...
                            12: (
                                ...
                                [[("text", 11)]],
                                {
                                    "blank": True,
                                    "features": ["bold", "italic", "link", "ul"],
                                    "help_text": "Inset text - TODO ask for better decsription of this? where it sits etc",
                                    "null": True,
                                    "verbose_name": "inset text",
                                },
                            ),
                        },
                        help_text="Add one title and description block, then optionally add logo, quote, and inset text blocks.",
                        null=True,
                ...
                (
                    ...
                    wagtail.fields.StreamField(
                        [("session_curriculum_connection_description", 0)],
                        blank=True,
                        block_lookup={
                            0: (
                                "app.core.blocks.paragraph.APIRichTextBlock",
            ...
            bases=(
                app.education.models.mixins.EducationTaxonomyMixin,
                app.core.models.mixins.CustomHeadlessPreviewMixin,
                "wagtailcore.page",
                models.Model,
            ),
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("online", "Online"),
                            ("national_archives", "At the National Archives"),
                            ("your_school", "At your school"),
                            ("custom", "Custom venue"),
                        ],
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="A clear description of the session duration, e.g. 1 hour, 1 to 2 hours.",
                        max_length=160,
                    ...
                    wagtail.fields.StreamField(
                        ...
                        block_lookup={
                            ...
                            1: (
                                ...
                                {
                                    "choices": [
                                        ("south_east_london", "South East and London"),
                                        ("south_west", "South West"),
                                        ("midlands", "Midlands"),
                                        ("north_east", "North East"),
                                        ("north_west", "North West"),
                                    ],
                                    "help_text": "The regions where the session is offered.",
                                    "label": "Regions",
                                    "required": False,
                                },
                            ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "enquiry_question",
                    models.CharField(
                        blank=True, max_length=160, verbose_name="enquiry question"
                    ),
                ),
                (
                    "sources_title",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    wagtail.fields.StreamField(
                        ...
                        block_lookup={
                            ...
                            4: ("app.media.blocks.MediaChooserBlock", (), {}),
                            5: (
                                "wagtail.blocks.StructBlock",
                                [[("thumbnail", 3), ("media", 4), ("caption", 1)]],
                                {},
                            ),
                            6: (
                                "wagtail.blocks.CharBlock",
                ...
                (
                    "featured_link",
                    wagtail.fields.StreamField(
                        [("external_link", 5), ("internal_link", 8)],
                        blank=True,
                        block_lookup={
                            0: (
                                "wagtail.blocks.CharBlock",
