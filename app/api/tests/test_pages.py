...
class APIResponseTest(WagtailPageTestCase):
    ...
    def setUpTestData(self):
        ...
        self.witchcraft, _ = ArticleTag.objects.get_or_create(
            name="Witchcraft", defaults={"skos_id": "Witchcraft"}
        )
        self.medicine, _ = ArticleTag.objects.get_or_create(
            name="Medicine", defaults={"skos_id": "Medicine"}
        )
