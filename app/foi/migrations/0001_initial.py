    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('short_title', models.CharField(blank=True, help_text='A shorter title for use in breadcrumbs and other navigational elements, where applicable.', max_length=46, null=True, verbose_name='short title')),
