    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intro', wagtail.fields.RichTextField(blank=True, help_text='1-2 sentences introducing the subject of the page, and explaining why a user should read on.', max_length=300, null=True, verbose_name='introductory text')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='access_listings', to='access.accesslandingpage')),
                ('access_point', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='access.accesspage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
