...
class LinkItem(Orderable):
    ...
    supertitle = models.CharField(
        ...
        null=True,
        blank=True,
        help_text="Optional text, ONLY use to simplify autogenerated chips, eg 'nationalarchives.wd3.myworkdayjobs.com' to 'myworkdayjobs.com'",
    )
    ...
    def clean(self) -> None:
        ...
        if self.internal_page and (
            self.url or self.title or self.description or self.image or self.supertitle
        ):
            raise ValidationError(
                {
