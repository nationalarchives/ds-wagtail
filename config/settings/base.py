...
AUTH0_EMAIL_VERIFICATION_REQUIRED = strtobool(
    os.getenv("AUTH0_EMAIL_VERIFICATION_REQUIRED", "true").lower()
)
AUTH0_VERIFY_EMAIL_URL = os.getenv(
    "AUTH0_VERIFY_EMAIL_URL",
    "https://tna-account-management-poc.torchbox.dev/verify-your-email",
)
if AUTH0_DOMAIN:
