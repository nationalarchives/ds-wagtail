...
import accordion_functionality from "./modules/article/accordion_functionality/accordion_functionality";
import add_event from "./modules/article/add_event";
import add_section_ids from "./modules/article/accordion_functionality/add_section_ids";
import apply_aria_roles from "./modules/article/accordion_functionality/apply_aria_roles";
import debounce from "./modules/debounce";
import jumplinks_smooth_scroll from './modules/article/navigation/jumplinks_smooth_scroll';
import open_first_section from "./modules/article/accordion_functionality/open_first_section";
import remove_aria_roles from "./modules/article/accordion_functionality/remove_aria_roles";
import remove_event from "./modules/article/remove_event";
import set_active from "./modules/article/navigation/set_active";
import set_heading_positions from "./modules/article/accordion_functionality/set_heading_positions";
