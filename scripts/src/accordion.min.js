!(function () {
    ...
    function i(t) {
        ...
        return (
            "true" === e ||
            ("false" !== e &&
                (e.length > 0 && isFinite(Number(e)) ? Number(e) : t))
        );
    }
    function o(t) {
        var e = {};
    ...
    function s(t, e) {
        (this.translations = t || {}),
            (this.locale =
                (e && e.locale) || document.documentElement.lang || "en");
    }
    (function (t) {
        var e, n, i, o;
                ...
                (function () {
                    if (!window.Element || window.HTMLElement) {
                        ...
                        var t,
                            ...
                            i = (Element.prototype = n.appendChild(
                                n.createElement("*"),
                            )),
                            o = {},
                            s = function (t, e) {
                    ...
                    ("DOMTokenList" in e &&
                        ...
                        "classList" in (n = document.createElement("span")) &&
                            ...
                            n.classList.contains("x") &&
                                (n.classList.constructor.prototype.toggle =
                                    function (e) {
                                        var n = arguments[1];
                                        if (n === t) {
                                            var i = !this.contains(e);
                                            return (
                                                this[i ? "add" : "remove"](e), i
                                            );
                                        }
                                        return (
                                            this[(n = !!n) ? "add" : "remove"](
                        ...
                        (function () {
                            ...
                            if (
                                ...
                                t.classList.constructor.prototype.add =
                                    function () {
                                        for (
                                            var t = arguments,
                                                n = arguments.length,
                        ...
                        (function () {
                            ...
                            if (
                                ...
                                var e =
                                    t.classList.constructor.prototype.remove;
                                t.classList.constructor.prototype.remove =
                                    function () {
                                        for (
                                            var t = arguments,
                    ...
                    if (
                        ...
                        (window.Event = Window.prototype.Event =
                            function (e, n) {
                                ...
                                return (
                                    ((i = document.createEventObject()).type =
                                        e),
                                    (i.bubbles =
                                        !(!n || n.bubbles === t) && n.bubbles),
                                    (i.cancelable =
                                        !(!n || n.cancelable === t) &&
                                        n.cancelable),
                                    i
    ...
    function a(t, i) {
        ...
        this.$module = t;
        var a = { i18n: r, rememberExpanded: !0 };
    ...
    (a.prototype.init = function () {
        ...
        (a.prototype.initSectionHeaders = function () {
            ...
            t(this.$sections, function (t, n) {
                ...
                i &&
                    (e.constructHeaderMarkup(i, n),
                    e.setExpanded(e.isExpanded(t), t),
                    i.addEventListener("click", e.onSectionToggle.bind(e, t)),
                    e.setInitialState(t));
            });
        }),
        ...
        (a.prototype.updateShowAllButton = function (t) {
            ...
            this.$showAllButton.setAttribute("aria-expanded", t.toString()),
                ...
                t
                    ? this.$showAllIcon.classList.remove(
                          this.downChevronIconClass,
                      )
                    : this.$showAllIcon.classList.add(
                          this.downChevronIconClass,
                      );
        });
    var l = {
    ...
    (a.prototype.storeState = function (t) {
        if (
            this.browserSupportsSessionStorage &&
    ...
    function c(t, n) {
        ...
        this.config = e({ preventDoubleClick: !1 }, n || {}, o(t.dataset));
    }
    ...
    function d(t, i) {
        ...
        if (
            !(r instanceof HTMLTextAreaElement || r instanceof HTMLInputElement)
        )
            return this;
        var a,
            l,
            c,
            d = { threshold: 0, i18n: u },
            h = o(t.dataset),
            p = {};
        if (
            (("maxwords" in h || "maxlength" in h) &&
                (p = { maxlength: !1, maxwords: !1 }),
            (this.config = e(d, i || {}, p, h)),
            (this.i18n = new s(n(this.config, "i18n"), {
                locale:
                    ((a = t),
                    (l = "lang"),
    ...
    (d.prototype.init = function () {
        ...
        (h.prototype.syncConditionalRevealWithInputState = function (t) {
            ...
            if (e) {
                ...
                if (
                    n &&
                    n.classList.contains("govuk-checkboxes__conditional")
                ) {
                    var i = t.checked;
            ...
            t(
                ...
                function (t) {
                    e.form === t.form &&
                        t !== e &&
                        ((t.checked = !1),
                        n.syncConditionalRevealWithInputState(t));
                },
            );
        }),
    ...
    function m(t, n) {
        if (!(t instanceof HTMLElement)) return this;
        this.$module = t;
        this.config = e({ disableAutoFocus: !1 }, n || {}, o(t.dataset));
    }
    (p.prototype.init = function () {
        ...
        (m.prototype.focusTarget = function (t) {
            ...
            return (
                !!i && (i.scrollIntoView(), n.focus({ preventScroll: !0 }), !0)
            );
        }),
    ...
    (v.prototype.initUpdateSpan = function () {
        ...
        (function (e) {
            var n =
                (e = void 0 !== e ? e : {}).scope instanceof HTMLElement
                    ? e.scope
                    : document;
            t(
