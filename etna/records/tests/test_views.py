...
class TestDataLayerRecordDetail(WagtailTestUtils, TestCase):
    ...
    def test_datalayer_level3(self):
        ...
        html_decoded_response = response.content.decode("utf8")
        desired_datalayer_script_tag = """<script id="gtmDatalayer" type="application/json">{"contentGroup1": "Catalogue: The National Archives", "customDimension1": "offsite", "customDimension2": "", "customDimension3": "record detail", "customDimension4": "", "customDimension5": "", "customDimension6": "", "customDimension7": "", "customDimension8": "", "customDimension9": "", "customDimension10": "", "customDimension11": "66 - The National Archives", "customDimension12": "Level 3 - Series", "customDimension13": "", "customDimension14": "RAIL 253 - Great Western Railway Company: Miscellaneous Books and Records", "customDimension15": "CAT", "customDimension16": "", "customDimension17": "", "customMetric1": "", "customMetric2": ""}</script>"""
        self.assertIn(desired_datalayer_script_tag, html_decoded_response)
    ...
    def test_datalayer_level4(self):
        ...
        html_decoded_response = response.content.decode("utf8")
        desired_datalayer_script_tag = """<script id="gtmDatalayer" type="application/json">{"contentGroup1": "Catalogue: The National Archives", "customDimension1": "offsite", "customDimension2": "", "customDimension3": "record detail", "customDimension4": "", "customDimension5": "", "customDimension6": "", "customDimension7": "", "customDimension8": "", "customDimension9": "", "customDimension10": "", "customDimension11": "Held by not available", "customDimension12": "Level 4 - Sub-series", "customDimension13": "", "customDimension14": "Sub-series within ADM 171 - AFRICA GENERAL SERVICE MEDAL 1902-1910", "customDimension15": "CAT", "customDimension16": "", "customDimension17": "", "customMetric1": "", "customMetric2": ""}</script>"""
        self.assertIn(desired_datalayer_script_tag, html_decoded_response)
    ...
    def test_datalayer_level5(self):
        ...
        html_decoded_response = response.content.decode("utf8")
        desired_datalayer_script_tag = """<script id="gtmDatalayer" type="application/json">{"contentGroup1": "Catalogue: The National Archives", "customDimension1": "offsite", "customDimension2": "", "customDimension3": "record detail", "customDimension4": "", "customDimension5": "", "customDimension6": "", "customDimension7": "", "customDimension8": "", "customDimension9": "", "customDimension10": "", "customDimension11": "Held by not available", "customDimension12": "Level 5 - Sub-sub-series", "customDimension13": "IR 900 - Specimens of Series of Documents Destroyed", "customDimension14": "Sub-sub-series within IR 900 - Camden Town Tax District", "customDimension15": "CAT", "customDimension16": "", "customDimension17": "", "customMetric1": "", "customMetric2": ""}</script>"""
        self.assertIn(desired_datalayer_script_tag, html_decoded_response)
    ...
    def test_datalayer_level6_nondigital(self):
        ...
        html_decoded_response = response.content.decode("utf8")
        desired_datalayer_script_tag = """<script id="gtmDatalayer" type="application/json">{"contentGroup1": "Catalogue: The National Archives", "customDimension1": "offsite", "customDimension2": "", "customDimension3": "record detail", "customDimension4": "", "customDimension5": "", "customDimension6": "", "customDimension7": "", "customDimension8": "", "customDimension9": "", "customDimension10": "", "customDimension11": "66 - The National Archives", "customDimension12": "Level 6 - Piece", "customDimension13": "RAIL 253 - Great Western Railway Company: Miscellaneous Books and Records", "customDimension14": "RAIL 253/516 - Correspondence by members of Audit Office, Paddington while on active service to...", "customDimension15": "CAT", "customDimension16": "", "customDimension17": "No availability condition provisioned for this record", "customMetric1": "", "customMetric2": ""}</script>"""
        self.assertIn(desired_datalayer_script_tag, html_decoded_response)
    ...
    def test_datalayer_level7_nondigital(self):
        ...
        html_decoded_response = response.content.decode("utf8")
        desired_datalayer_script_tag = """<script id="gtmDatalayer" type="application/json">{"contentGroup1": "Catalogue: The National Archives", "customDimension1": "offsite", "customDimension2": "", "customDimension3": "record detail", "customDimension4": "", "customDimension5": "", "customDimension6": "", "customDimension7": "", "customDimension8": "", "customDimension9": "", "customDimension10": "", "customDimension11": "66 - The National Archives", "customDimension12": "Level 7 - Item", "customDimension13": "DSIR 27 - Department of Scientific and Industrial Research: Road Research Laboratory Reports", "customDimension14": "DSIR 27/6/ADM171 - The pressures produced by explosions underwater of 1-oz. solid cone charges of P.E....", "customDimension15": "CAT", "customDimension16": "", "customDimension17": "No availability condition provisioned for this record", "customMetric1": "", "customMetric2": ""}</script>"""
        self.assertIn(desired_datalayer_script_tag, html_decoded_response)
    ...
    def test_datalayer_level7_digital(self):
        ...
        html_decoded_response = response.content.decode("utf8")
        desired_datalayer_script_tag = """<script id="gtmDatalayer" type="application/json">{"contentGroup1": "Catalogue: The National Archives", "customDimension1": "offsite", "customDimension2": "", "customDimension3": "record detail", "customDimension4": "", "customDimension5": "", "customDimension6": "", "customDimension7": "", "customDimension8": "", "customDimension9": "", "customDimension10": "", "customDimension11": "66 - The National Archives", "customDimension12": "Level 7 - Item", "customDimension13": "WO 95 - War Office: First World War and Army of Occupation War Diaries", "customDimension14": "WO 95/1510/4 - Headquarters Branches and Services: General Staff.", "customDimension15": "CAT", "customDimension16": "", "customDimension17": "No availability condition provisioned for this record", "customMetric1": "", "customMetric2": ""}</script>"""
        self.assertIn(desired_datalayer_script_tag, html_decoded_response)
