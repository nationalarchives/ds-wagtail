...
class TestMachineReadableDetailsRouteResolution(TestCase):
    def test_resolves_iaid(self):
        ...
        self.assertEqual(resolver.kwargs["metadata_id"], "C7810139")
    ...
    def test_iaid_with_non_standard_prefix(self):
        ...
        self.assertEqual(resolver.kwargs["metadata_id"], "C123456")
    ...
    def test_resolves_uuid(self):
        ...
        self.assertEqual(resolver.view_name, "details-page-machine-readable")
        self.assertEqual(
            resolver.kwargs["metadata_id"], "43f766a9-e968-4b82-93dc-8cf11a841d41"
        )
...
class TestMachineReadableDetailsURL(TestCase):
    def test_reverse_iaid(self):
        url = reverse(
            "details-page-machine-readable", kwargs={"metadata_id": "C7810139"}
        )
    ...
    def test_reverse_uuid(self):
        url = reverse(
            ...
            kwargs={"metadata_id": "43f766a9-e968-4b82-93dc-8cf11a841d41"},
        )
