...
class TestMachineReadableDetailsRouteResolution(TestCase):
    def test_resolves_metadataId(self):
        resolver = resolve("/catalogue/id/C7810139/")

        self.assertEqual(resolver.view_name, "details-page-machine-readable")
        self.assertEqual(resolver.kwargs["metadataId"], "C7810139")

    def test_metadataId_with_non_standard_prefix(self):
        resolver = resolve("/catalogue/id/C123456/")

        self.assertEquals(resolver.view_name, "details-page-machine-readable")
        self.assertEqual(resolver.kwargs["metadataId"], "C123456")

    def test_resolves_uuid(self):
        # Some metadataIds are UUIDs. Tested metadataId is a real example
        resolver = resolve("/catalogue/id/43f766a9-e968-4b82-93dc-8cf11a841d41/")

        self.assertEqual(resolver.view_name, "details-page-machine-readable")
        self.assertEqual(
            resolver.kwargs["metadataId"], "43f766a9-e968-4b82-93dc-8cf11a841d41"
        )
...
class TestMachineReadableDetailsURL(TestCase):
    ...
    def test_reverse_uuid(self):
        url = reverse(
            ...
            kwargs={"metadataId": "43f766a9-e968-4b82-93dc-8cf11a841d41"},
        )
