...
def move_alt_text(apps, schema_editor):
    StoriesPage = apps.get_model("stories", "StoriesPage")

    for page in StoriesPage.objects.select_related("hero_image").exclude(
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("stories", "0028_migrate_image_block_values_to_new_block_structure"),
    ]
