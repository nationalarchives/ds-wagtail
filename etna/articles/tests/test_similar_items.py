...
class TestFocusedArticlePageSimilarItems(TestCase):
    ...
    def test_search_prevented_if_no_tag_matches_identified(self):
        ...
        with self.assertNumQueries(3):
            ...
            # Local queries:
            # 1. SELECT "articles_taggedarticle"."tag_id"...
            # 3. SELECT "wagtailcore_pageviewrestriction"."id"...
            # 4. SELECT "wagtailcore_page"."id"...

            # GitHub Action queries:
            # 1. SELECT "articles_taggedarticle"."tag_id"...
            # 2. SELECT "django_content_type"."id"...
            # 3. SELECT "wagtailcore_pageviewrestriction"."id"...
            # 4. SELECT "wagtailcore_page"."id"...
