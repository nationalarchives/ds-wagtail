    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chapters', wagtail.fields.StreamField([('chapter', 3)], blank=True, block_lookup={0: ('wagtail.blocks.IntegerBlock', (), {'blank': True, 'default': 0, 'label': 'Time in seconds', 'validators': [django.core.validators.MinValueValidator(0)]}), 1: ('wagtail.blocks.CharBlock', (), {'max_length': 20}), 2: ('etna.core.blocks.paragraph.APIRichTextBlock', (), {'features': ['bold', 'italic'], 'required': False}), 3: ('wagtail.blocks.StructBlock', [[('time', 0), ('heading', 1), ('transcript', 2)]], {})}, null=True)),
