...
from etna.core.blocks import ContentImageBlock, SectionDepthAwareStructBlock, PageListBlock

from etna.collections.blocks import TopicExplorerIndexBlock, TimePeriodExplorerIndexBlock
