...
class HeroImageMixin(models.Model):
    ...
    api_fields = [
        ...
        APIField(
            "hero_image_jpg",
            serializer=ImageRenditionField("fill-1200x400|format-jpeg|jpegquality-60", source="hero_image"),
        ),
        APIField(
            "hero_image_webp",
        ...
        APIField(
            ...
            serializer=ImageRenditionField("fill-600x400|format-jpeg|jpegquality-60", source="hero_image"),
        ),
        APIField(
