...
class FeaturedRecordBlock(SectionDepthAwareStructBlock):
    ...
    image = ImageBlock(
        ...
        template="article/blocks/images/blog-embed__image-container.html",
    )

    class Meta:
        icon = "archive"
        template = "article/blocks/featured_record.html"
...
class FeaturedRecordsBlock(SectionDepthAwareStructBlock):
    ...
    class Meta:
        icon = "archive"
        template = "article/blocks/featured_records.html"
...
class PromotedItemBlock(SectionDepthAwareStructBlock):
    ...
    class Meta:
        label = "Featured link"
        template = "article/blocks/promoted_item.html"
...
class PromotedListBlock(blocks.StructBlock):
    ...
    class Meta:
        ...
        label = "Link list"
        template = "article/blocks/promoted_list_block.html"
...
class RelatedItemBlock(SectionDepthAwareStructBlock):
    ...
    class Meta:
        icon = "external-link-alt"
        help_text = "Block used promote an external page"
        template = "article/blocks/related_item.html"
...
class FeaturedCollectionBlock(SectionDepthAwareStructBlock):
    ...
    class Meta:
        ...
        template = "article/blocks/featured_collection.html"
...
class QuoteBlock(SectionDepthAwareStructBlock):
    ...
    class Meta:
        icon = "openquote"
        label = "Quote"
        template = "article/blocks/quote.html"
...
class SubHeadingBlock(SectionDepthAwareStructBlock):
    ...
    class Meta:
        icon = "heading"
        label = "Sub-heading"
        template = "article/blocks/sub_heading.html"
