    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body', wagtail.fields.StreamField([('paragraph', 1), ('paragraph_with_heading', 4)], blank=True, block_lookup={0: ('etna.core.blocks.paragraph.APIRichTextBlock', (), {'features': ['bold', 'italic', 'link', 'ol', 'ul']}), 1: ('wagtail.blocks.StructBlock', [[('text', 0)]], {}), 2: ('wagtail.blocks.CharBlock', (), {'max_length': 100, 'required': True}), 3: ('etna.core.blocks.paragraph.APIRichTextBlock', (), {'features': ['bold', 'italic', 'link', 'ol', 'ul'], 'required': True}), 4: ('wagtail.blocks.StructBlock', [[('heading', 2), ('paragraph', 3)]], {})}, null=True)),
