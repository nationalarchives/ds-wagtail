...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('insights', '0026_add_accessible_image_block'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=wagtail.core.fields.RichTextField(blank=True, verbose_name="hero image caption (optional)", help_text='An optional caption for non-decorative images, which will be displayed directly below the image. This could be used for image sources or for other useful metadata.'),
        ),
    ]
