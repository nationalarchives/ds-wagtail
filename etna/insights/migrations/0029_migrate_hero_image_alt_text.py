...
def move_alt_text(apps, schema_editor):
    ...
    for page in InsightsPage.objects.select_related("hero_image").exclude(hero_image__isnull=True):
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("insights", "0028_migrate_image_block_values_to_new_block_structure"),
    ]
