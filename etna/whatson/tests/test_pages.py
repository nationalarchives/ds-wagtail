...
class TestWhatsOnPageEventFiltering(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.event_page1 = EventPageFactory(
            ...
            min_price=0,
            max_price=0,
            start_date=timezone.datetime(2023, 10, 17, tzinfo=timezone.get_current_timezone()),
            sessions=[
                EventSession(
                    page=cls.whats_on_page,
                    start=timezone.datetime(2023, 10, 15, tzinfo=timezone.get_current_timezone()),
                    end=timezone.datetime(2023, 10, 16, tzinfo=timezone.get_current_timezone()),
                )
            ],
        )
        ...
        cls.event_page2 = EventPageFactory(
            ...
            sessions=[
                EventSession(
                    page=cls.whats_on_page,
                    start=timezone.datetime(2023, 10, 17, tzinfo=timezone.get_current_timezone()),
                    end=timezone.datetime(2023, 10, 18, tzinfo=timezone.get_current_timezone()),
                )
            ],
        )
        ...
        cls.event_page3 = EventPageFactory(
            ...
            min_price=15,
            max_price=30,
            start_date=timezone.datetime(2023, 10, 20, tzinfo=timezone.get_current_timezone()),
            sessions=[
                EventSession(
                    page=cls.whats_on_page,
                    start=timezone.datetime(2023, 10, 20, tzinfo=timezone.get_current_timezone()),
                    end=timezone.datetime(2023, 10, 21, tzinfo=timezone.get_current_timezone()),
                )
            ],
        )
