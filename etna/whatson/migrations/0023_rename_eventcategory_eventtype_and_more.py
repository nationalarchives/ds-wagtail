...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            ...
            options={'verbose_name': 'Category listing page', 'verbose_name_plural': 'Category listing pages'},
        ),
        migrations.AlterModelOptions(
            name='whatsonseriespage',
            options={'verbose_name': 'Series listing page', 'verbose_name_plural': 'Series listing pages'},
        ),
